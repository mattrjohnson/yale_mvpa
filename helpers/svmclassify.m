function [outclass rawresults] = svmclassify(svmStruct,sample, varargin) %MRJ
...
%disp('svmclassify: modified by MRJ 2010-01-15'); %MRJ
...
if ~isempty(sample)
    ...
    try
        [classified rawresults] = svmdecision(sample,svmStruct); %MRJ
    catch theException
